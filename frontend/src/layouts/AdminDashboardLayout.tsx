...
const AdminDashboard = () => {
  ...
  //   }
    ...
    const menuItems = [
  { label: "Albums", icon: Album ,link:'/admin-dashboard/albums'},
  { label: "Songs", icon: Music,link:'/admin-dashboard/songs' },
  { label: "Category", icon: ListMusic, link:'/admin-dashboard/categories'},
  { label: "Add Song", icon: ListMusic, link:'/admin-dashboard/add-song'},
  { label: "Add Album", icon: ListMusic, link:'/admin-dashboard/add-album'},
  { label: "Add Category", icon: User2Icon,link:'/admin-dashboard/add-category' },
